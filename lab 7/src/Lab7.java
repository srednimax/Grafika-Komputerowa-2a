...
public class Lab7 extends JPanel implements GLEventListener {
    ...
    private void triangularPrism(GL2 gl2) {
        ...
        gl2.glBegin(GL_TRIANGLE_FAN); // back face (side facing towards negative z-axis)
        ...
        gl2.glBegin(GL_TRIANGLE_FAN); // front left face
        ...
        gl2.glBegin(GL_TRIANGLE_FAN); // front right face
        gl2.glNormal3d(0.75, 0, t);
        gl2.glVertex3d(0, 0.5, 0.5);
        gl2.glVertex3d(0, -0.5, 0.5);
        gl2.glVertex3d(t, -0.5, -0.25);
    ...
    private void piramid(GL2 gl2) {
       ...
       // gl2.glColor3f(0.6f, 0.01f, 0.46f);
        ...
        for (int angle = 0; angle < 360; angle += 40) {
            ...
            gl2.glTexCoord2d(x+0.4,y+0.4);
            gl2.glVertex3f(x, 0-down, y);
        }
        gl2.glEnd();
        //pokrywa
        ...
        for (int i = 0; i < 9; i++) {
           // gl2.glColor3f(r, g, b);
            ...
            gl2.glTranslatef(-0.0f * size, 0f-down, -0.95f * size);
    ...
    private void triangle(GL2 gl2, float size) {
        ...
        gl2.glTexCoord2d(0.4,1);
        gl2.glVertex3f(-0.4f * size, 0, 0f);
        gl2.glTexCoord2d(0.2,1);
        gl2.glVertex3f(0.4f * size, 0, 0f);
        gl2.glTexCoord2d(0.3,0.2);
